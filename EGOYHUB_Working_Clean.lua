local function ApplyProfessionalTransparentUI(root)
    if not root then return end
    local function style(obj)
        if obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
            obj.BackgroundTransparency = math.max(obj.BackgroundTransparency, 0.10)
        ...
        if obj:IsA("UICorner") then obj.CornerRadius = UDim.new(0, 10) end
    end
    style(root)
...
do
    ...
    local EGOYHub = v4.EGOYHub

    if type(EGOYHub) ~= "table" then
        EGOYHub = {
            slots = {}
        }
        v4.EGOYHub = EGOYHub
    ...
    if type(EGOYHub.slots) ~= "table" then
        EGOYHub.slots = {}
    end
    ...
    do
        local v6 = EGOYHub.slots[str]

        if type(v6) ~= "table" then
            v6 = {}
            EGOYHub.slots[str] = v6
        end
        ...
        for k, v in pairs(EGOYHub.slots) do
        ...
        if not v7 then
            v4.EGOYCfgGen = (tonumber(v4.EGOYCfgGen) or 0) + 1
        end
    ...
    if type(unload) == "function" then
        pcall(unload)
    elseif type(v4.EGOYUnload) == "function" then
        local EGOYUnloadUid = v4.EGOYUnloadUid
        local v12 = EGOYUnloadUid == nil or str == tostring(EGOYUnloadUid)

        if EGOYUnloadUid == nil then
            for k, v in pairs(EGOYHub.slots) do
        ...
        if v12 then
            local EGOYUnload = v4.EGOYUnload

            if str == tostring(EGOYUnloadUid or str) then
                v4.EGOYUnload = nil
                v4.EGOYUnloadUid = nil
            end
...
t1.LogoFile = "EGOY" .. "/logo.png"
t1.LogoFileLight = "EGOY" .. "/logo-light.png"
local n1 = 620
local n2 = 430
local n3 = 152
local Players = game:GetService("Players")
...
do
    ...
    do
        ...
        do
            ...
            function v51()
                ...
                local EGOYHub = v350.EGOYHub

                if type(EGOYHub) ~= "table" then
                    EGOYHub = {
                        slots = {}
                    }
                    v350.EGOYHub = EGOYHub
                end
                ...
                local v352 = EGOYHub.slots[str]

                if type(v352) ~= "table" then
                    v352 = {}
                    EGOYHub.slots[str] = v352
                end

                return v352
            end

            t1.ConfigFile = (("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/" .. v26(LocalPlayer and LocalPlayer.Name or "Player") .. "-config.json"
            t2 = {
                Dark = {
                    ...
                    EGOY = Color3.fromRGB(246, 242, 234)
                },
                Light = {
            ...
            if PH_UI then
                local EGOYUnloadUid = (getgenv and getgenv() or _G).EGOYUnloadUid

                if EGOYUnloadUid == nil or str == tostring(EGOYUnloadUid) then
                    PH_UI:Destroy()
                end
            end
    ...
    do
        ...
        local t32 = {
            ...
            BackgroundTransparency = 0.122.7,
    ...
    local function v271(p58, p59)
        ...
        local v602 = "EGOY" .. "/" .. v26(t1.Game)

        if type(makefolder) == "function" then
            pcall(makefolder, v602)
        end

        local v603 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/cache"

        if type(makefolder) == "function" then
            pcall(makefolder, v603)
        end

        local v604 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs"
    ...
    function v272(p60)
        ...
        if not v271((("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/" .. v26(LocalPlayer and LocalPlayer.Name or "Player") .. "-config.json", result) then
            v271((("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/" .. str .. "-config.json", result)
        end
    end
    ...
    local function v276()
        ...
        if type(listfiles) == "function" then
            local ok, result = pcall(listfiles, ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs")
    ...
    function v278(p68)
        ...
        local v647 = v271
        local v648 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs"
    ...
    function v279(p69, p70)
        ...
        local v654 = v275
        local v655 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs"
    ...
    function v280(p71)
        ...
        local v661, v662 = v275((("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/" .. v26(LocalPlayer and LocalPlayer.Name or "Player") .. "-config.json")

        if not v661 then
            v661, v662 = v275((("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/" .. str .. "-config.json")
        end

        if not v661 then
            local v663 = v275
            local v664 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs"
        ...
        if not v661 then
            local t85 = {
                ("EGOY" .. "/" .. v26(t1.Game)) .. "/config.json",
                "EGOY" .. "/config.json",
                "EGOY" .. "/" .. t1.Game .. "/config.json",
                ("EGOY" .. "/" .. v26(t1.Game)) .. "/EGOY.json",
                "EGOY" .. "/EGOY.json",
                "EGOY.json"
            }
        ...
        if v662 ~= (("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/" .. v26(LocalPlayer and LocalPlayer.Name or "Player") .. "-config.json" then
            v272(true)
        end
...
local v294 = v259("About", "EGOY HUB for Steal an Egg")
...
v282(v295, "StealSpeed", "Travel speed", "Studs/s — capped at 700 for egg travel", 50, 700, 700, " studs/s")
v263(v295, "Targeting")
...
v263(v295, "Event")
v281(v295, "AutoEvent", "Auto Event (Latest)", "uses the current event handler when supported", false)
v288(v295, "EventKeepGen", "Don't feed if egg makes ($/s)", "keeps high-pay eggs · blank = feed any", "feed any · e.g. 5m", "")
v281(v295, "WallBypass", "Wall bypass", "targeted wall-collision assist while returning the egg", true)
v281(v295, "CarryHover", "Carry hover", "keeps the character slightly above the floor while returning an egg", true)
v282(v295, "CarryHoverHeight", "Carry height", "small mid-air offset · not a high flight", 2, 10, 6, " studs")
v263(v296, "Eggs & pets")
...
v290(v300, "FlightBind2", "Toggle flight", "same bind as the movement page", t1.FlightBind)
    v290(v300, "StealBind", "Toggle auto steal", "press this to start or stop Auto Steal", t1.StealBind)
...
v289(v300, "SaveCfgAs", "Save config", "writes EGOY/.../configs/<name>.json", "Save", function()
    v278(t9.CfgSaveName)
end, true)
...
v325.UI = t149
v324.EGOYUI = type(v324.EGOYUI) == "table" and v324.EGOYUI or {}
v324.EGOYUI[str] = t149
if type(v324.UI) ~= "table" or not (function()
    local EGOYHub = (getgenv and getgenv() or _G).EGOYHub
    local v354 = type(EGOYHub) == "table" and EGOYHub.slots
...
(function()
    ...
    local function v1144()
        ...
        if v1494 then
            for _, child in ipairs(workspace:GetChildren()) do
                if child.Name == "EGOYSupport" or child.Name == "Hub45Support" then
                    pcall(function()
                        child:Destroy()
                    end)
                end
    ...
    local function v1151()
        ...
        if u1128 and typeof(u1127) == "Vector3" then
            return math.clamp(tonumber(t9.StealSpeed) or 700, 50, 700)
        end
    ...
    local u1195 = (function()
        ...
        local function v1810(p269, p270, p271)
            ...
            if p271 and p271.bytes then
                local v2996 = "EGOY" .. tostring(math.floor(os.clock() * 1000000)) .. tostring(math.random(100000, 999999))
        ...
        local function v1811(p272)
            ...
            local str9 = tostring(p272.title or "EGOY")
            local v3014
            local g3028
            local str10
            local s17
            ...
            t184.text = v3018 == "" and "EGOY HUB" or "EGOY HUB · " .. v3018
            t183.footer = t184
    ...
    function t216.wallUp()
        -- Do not stall the return state on the local wall-lock signal when
        -- the wall-assist option is enabled.
        if t9.WallBypass == true then
            return false
        end
    ...
    function t216.applyWallBypass()
        if t9.WallBypass ~= true or t216.carrying ~= true or t216.state ~= "Return" then
            return
        end
        ...
        pcall(function()
            ...
            local wallRoot = areas and areas:FindFirstChild("WallStartVisual")

            if not wallRoot then
                return
            end

            -- The wall visual may be a Model/Folder containing several collision
            -- pieces.  Handle the complete wall assembly instead of only the
            -- top-level BasePart.
            local parts = {}
            if wallRoot:IsA("BasePart") then
                parts[1] = wallRoot
            else
                for _, item in ipairs(wallRoot:GetDescendants()) do
            ...
            -- Only assist when the player is actually close to the wall.
            -- This avoids changing unrelated map collisions during normal play.
    ...
    function t216.applyCarryHover()
        if t9.CarryHover ~= true or t216.carrying ~= true then
            return
        end
        ...
        -- Keep the carry assist low: a small floor offset rather than a high flight.
        local floor = t216.floorY and t216.floorY() or root.Position.Y
        local height = math.clamp(tonumber(t9.CarryHoverHeight) or 6, 2, 10)
        local targetY = floor + height

        if t216.state == "Return" and math.abs(root.Position.Y - targetY) > 1.5 then
            pcall(function()
    ...
    t216._assistConnection = t216._assistConnection or RunService.Heartbeat:Connect(function()
        pcall(function()
            t216.applyWallBypass()
            t216.applyCarryHover()
        end)
    end)
    ...
    u1134 = (function()
        ...
        local function v2119()
            local EGOYEsp = workspace:FindFirstChild("EGOYEsp")

            if EGOYEsp and EGOYEsp:IsA("Folder") then
                t218.folder = EGOYEsp
        ...
        local function v2120()
            ...
            if PlayerGui then
                local v3251 = PlayerGui:FindFirstChild(v49) or PlayerGui:FindFirstChild("EGOYWorldGui")
        ...
        local function v2130(p355, p356)
            ...
            if v3353 then
                ...
                p355.card.BackgroundTransparency = 0.122.28
                ...
                p355.card.BackgroundTransparency = 0.122.34
        ...
        local function v2131()
            ...
            local t223 = {
                ...
                BackgroundTransparency = 0.122.34,
                BorderSizePixel = 0,
                Size = UDim2.fromScale(1, 1),
                ClipsDescendants = true,
                ZIndex = 1,
        ...
        local function v2143(p370)
            if p370 then
                ...
                elseif t218.world and p370:IsDescendantOf(t218.world) then
                    ...
                    v3530 = p370Name == "EGOYSupport" or (p370Name == "Hub45Support" or (p370Name == "EGOYWorldGui" or (p370Name == v49 or p370Name == v48)))
                end
    ...
    local u1230 = (function()
        ...
        v2192.EGOYHopUsed = type(v2192.EGOYHopUsed) == "table" and v2192.EGOYHopUsed or {}
        v2192.EGOYHopRing = type(v2192.EGOYHopRing) == "table" and v2192.EGOYHopRing or {}
        v2192.EGOYHopCache = type(v2192.EGOYHopCache) == "table" and v2192.EGOYHopCache or {}
        if type(v2192.EGOYHopUntil) == "number" then
            ...
            if math.abs(v2195 - v2192.EGOYHopUntil) < 10 then
            end
        end
        ...
        local function v2197(p390)
            ...
            local EGOYHopRing = v2192.EGOYHopRing

            for i = #EGOYHopRing, 1, -1 do
                if p390 == EGOYHopRing[i] then
                    table.remove(EGOYHopRing, i)
                end
            end

            EGOYHopRing[#EGOYHopRing + 1] = p390

            while #EGOYHopRing > 48 do
                table.remove(EGOYHopRing, 1)
            end
        end
        local function v2198(p391)
            ...
            local g3859
            local v3858
            for i = 1, #EGOYHopRing do
                if str28 == EGOYHopRing[i] then
                    v3858 = true
                    g3859 = true
                end
            ...
            local v3860 = v2192.EGOYHopUsed[str28]
            if type(v3860) ~= "number" then
                return false
            end
            if os.time() - v3860 > 2100 then
                v2192.EGOYHopUsed[str28] = nil
        ...
        local function v2199()
            ...
            local ok54, result54 = pcall(readfile, (("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/hop-used.json")
            ...
            if type(data.jobs) == "table" then
                for k, v in pairs(data.jobs) do
                    ...
                    if v3867 and timestamp - v3867 <= 2100 and v3867 > (tonumber(v2192.EGOYHopUsed[str29]) or 0) then
                        v2192.EGOYHopUsed[str29] = v3867
                    end
                end
            end
            if type(data.ring) == "table" then
                ...
                for i = 1, #v2192.EGOYHopRing do
                    local v3874 = v2192.EGOYHopRing[i]
                ...
                v2192.EGOYHopRing = t282

                while #v2192.EGOYHopRing > 48 do
                    table.remove(v2192.EGOYHopRing, 1)
                end
            end
        end
        local function v2200()
            ...
            local v3875 = "EGOY" .. "/" .. v26(t1.Game)

            if type(makefolder) == "function" then
                pcall(makefolder, v3875)
            end

            local v3876 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/cache"

            if type(makefolder) == "function" then
                pcall(makefolder, v3876)
            end

            local v3877 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs"
            ...
            for k, v in pairs(v2192.EGOYHopUsed) do
            ...
            if ok55 and type(result55) == "string" then
                pcall(writefile, (("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/hop-used.json", result55)
            end
        end
        v2199()
        local str30 = tostring(tostring(game.JobId) or "")
        if str30 ~= "" then
            v2192.EGOYHopUsed[str30] = os.time()
            v2197(str30)
        end
        v2200()
        ...
        local function v2205(p395)
            local EGOYHopCache = v2192.EGOYHopCache

            if type(EGOYHopCache) ~= "table" or (EGOYHopCache.key ~= v2203() or type(EGOYHopCache.list) ~= "table" or #EGOYHopCache.list == 0) then
                EGOYHopCache = nil

                if type(readfile) == "function" then
                    local ok58, result58 = pcall(readfile, (("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/hop-list.json")
                    ...
                    if ok58 and type(result58) == "string" and result58 ~= "" then
                        ...
                        if type(data) == "table" and data.key == v2203() and type(data.list) == "table" and #data.list > 0 then
                            EGOYHopCache = data
                            v2192.EGOYHopCache = data
                        end
                    end
                end
            end

            if type(EGOYHopCache) ~= "table" or type(EGOYHopCache.list) ~= "table" or #EGOYHopCache.list == 0 then
                return
            end

            local v3913 = os.time() - (tonumber(EGOYHopCache.at) or 0)

            if v3913 > 90 and not p395 then
                return
            end

            v2204(EGOYHopCache.list)
        ...
        local function v2206(p396)
            ...
            if type(writefile) == "function" then
                ...
                local v3916 = "EGOY" .. "/" .. v26(t1.Game)

                if type(makefolder) == "function" then
                    pcall(makefolder, v3916)
                end

                local v3917 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/cache"

                if type(makefolder) == "function" then
                    pcall(makefolder, v3917)
                end

                local v3918 = ("EGOY" .. "/" .. v26(t1.Game)) .. "/configs"
                ...
                if ok59 and type(result59) == "string" then
                    pcall(writefile, (("EGOY" .. "/" .. v26(t1.Game)) .. "/cache") .. "/hop-list.json", result59)
                end
            end
        end
        ...
        local function v2208()
            ...
            for i = math.max(1, #EGOYHopRing - 7), #EGOYHopRing do
                local v3939 = EGOYHopRing[i]
        ...
        local function v2209()
            ...
            if str35 ~= "" then
                v2192.EGOYHopUsed[str35] = os.time()
                v2197(str35)
            end
        ...
        local function v2211(p399)
            ...
            while u1117 and u2179 do
                ...
                v3984.EGOYHopUntil = (not ok62 or type(result62) ~= "number") and 0 or math.max(0, result62)
                u2178 = true
    ...
    u1135 = (function()
        ...
        local function v2250()
            -- Robust treadmill state machine: one action per tick, cached belt lookup,
            -- explicit distance check, retry/backoff, and clean hand-off to Auto Steal.
            if t9.AutoTreadmill ~= true then
                if t291.training or t291.job == "belt" or t291.job == "leave" then
                    v2235()
                end
                return
            end

            -- Auto Steal has priority whenever it is actively driving an egg.
            if t9.AutoSteal == true and t216 and t216.running then
                local canTrain = false
                if type(t216.allowTrain) == "function" then
                    local ok, result = pcall(t216.allowTrain)
                    canTrain = ok and result == true
                end
            ...
            elseif t9.TrainWhenIdle ~= true then
                if t291.training or t291.job == "belt" or t291.job == "leave" then
                    v2235()
                end
                return
            ...
            -- Do not enter the belt during the early-steal window.
            local readyEarly = math.max(0, tonumber(t9.ReadyEarly) or 4)
            local resetTime = tonumber(v1228()) or math.huge
            if resetTime <= readyEarly then
            ...
            local belt = v2225()
            if not belt or not belt:IsA("BasePart") or not belt.Parent then
                t291.training = false
                t291.job = "idle"
                t291.beltPart = nil
                t291.beltAt = 0
                t291.trainWhy = "treadmill not found"
                return
            end

            local target = belt.Position + Vector3.new(0, belt.Size.Y * 0.5 + 3.2, 0)
            local horizontal = Vector3.new(Root.Position.X - belt.Position.X, 0, Root.Position.Z - belt.Position.Z)
            local distance = horizontal.Magnitude
            local heightOk = math.abs(Root.Position.Y - belt.Position.Y) < 10

            t291.job = "belt"

            if distance > 5.5 or not heightOk then
                t291.training = false
                t291.trainWhy = "moving to treadmill"
                local now = os.clock()
                if now - (t291.lastTrainMove or 0) >= 0.20 then
                    t291.lastTrainMove = now
                    pcall(function()
                        v2233(target)
                    end)
                end
            ...
            -- We are on the belt: ask the game's own treadmill remote to wear it.
            if u1119 then
                return
            end

            local now = os.clock()
            if now - (t291.lastTrain or 0) < 1.0 then
                return
            end
            t291.lastTrain = now
            u1128 = false
            ...
            local remoteOk, result, reason = pcall(function()
                return v2219("Treadmill", "AskWearStill")
            end)

            if remoteOk and result == true then
                t291.training = true
                t291.trainWhy = nil
                t291.trainFail = 0
            else
                t291.training = false
                t291.trainFail = (t291.trainFail or 0) + 1
                t291.trainWhy = tostring(reason or result or "wear rejected")
                v1102("plot", "treadmill wear fail", t291.trainWhy)

                -- Force a fresh belt lookup after repeated failures (plot reload/respawn).
                if t291.trainFail >= 3 then
                    t291.beltPart = nil
                    t291.beltAt = 0
                    t291.trainFail = 0
                end
        ...
        local function v2251()
            ...
            elseif t291.job == "belt" and not t291.training then
                local v4461 = (t291.trainWhy or "moving to treadmill") .. " · " .. v2217(t291.trainRate) .. "/s · earned " .. v2217(t291.trainEarned) .. " this session"
                local AutoTreadmill = t10.AutoTreadmill
    ...
    v1136(UserInputService.InputBegan:Connect(function(input, gameProcessed)
        ...
        if t9.StealBind and input.KeyCode == t9.StealBind then
            local enabled = not not t9.AutoSteal
            enabled = not enabled
            if t10.AutoSteal and t10.AutoSteal.set then
                t10.AutoSteal.set(enabled)
            else
                t9.AutoSteal = enabled
            end
            if t10.AutoSteal and t10.AutoSteal.on then
                pcall(t10.AutoSteal.on, enabled)
            end
        end
    end))
    ...
    pcall(function()
        LocalPlayer.CharacterAdded:Connect(function()
            task.defer(function()
                if u1135 then
                    -- Plot/treadmill instances can be recreated after respawn.
                    pcall(function()
                        if type(u1135.resetTreadmillCache) == "function" then
                            u1135.resetTreadmillCache()
                        end
                    end)
                end
            end)
    ...
    function u323()
        ...
        local ok103, result99, _, _ = pcall(function()
            ...
            if PlayerGui then
                local EGOYWorldGui = PlayerGui:FindFirstChild("EGOYWorldGui")

                if EGOYWorldGui then
                    EGOYWorldGui:Destroy()
                end
            end
        ...
        if type(v2668.EGOYUI) == "table" then
            v2668.EGOYUI[str] = nil
        end

        if type(v2668.EGOYDumpByUser) == "table" then
            v2668.EGOYDumpByUser[str] = nil
        end
        ...
        if v2668.EGOYUnloadUid == str then
            v2668.EGOYUnloadUid = nil
            v2668.EGOYUnload = nil
        end
    ...
    v1244.unload = u323
    v1244.alive = true
    v1243.EGOYUnloadUid = str
    function v1243.EGOYUnload()
        local LocalPlayer2 = Players.LocalPlayer
        local str42 = tostring(LocalPlayer2 and LocalPlayer2.UserId or 0)
        local EGOYHub = v1243.EGOYHub
        local v2673 = type(EGOYHub) == "table" and (type(EGOYHub.slots) == "table" and EGOYHub.slots[str42])

        if type(v2673) == "table" and type(v2673.unload) == "function" then
            v2673.unload()
        end
    end
    function t149.EGOYDump()
    ...
    local v1245 = v50()
    v51().dump = t149.EGOYDump
    v1245.EGOYDumpByUser = type(v1245.EGOYDumpByUser) == "table" and v1245.EGOYDumpByUser or {}
    v1245.EGOYDumpByUser[str] = t149.EGOYDump
    function v1245.EGOYDump(...)
        local LocalPlayer3 = Players.LocalPlayer
        local str43 = tostring(LocalPlayer3 and LocalPlayer3.UserId or 0)
        local v2683 = v1245.EGOYDumpByUser and v1245.EGOYDumpByUser[str43]

        if type(v2683) == "function" then
            return v2683(...)
        end
    end
    print("[UI] EGOY HUB ready · RightShift toggles · Dark / Light in Settings")
    v1102("boot", "game logic attached · EGOYDump() in F9")
end)()
