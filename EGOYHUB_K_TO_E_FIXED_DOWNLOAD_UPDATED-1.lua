...
(function()
        ...
        if t216.carrying then
            ...
            if t216.state == "Grab" or t216.state == "GoEgg" or t216.state == "Chase" then
                if t216.target and t216.target.event then
                    -- Current-event eggs use the normal return route.
                    -- The old Hungry Monster/infested feeding flow is retired.
                    t216.eventUid = t216.heldUid or t216.carryUid
                    t216.eventFromField = true

                    if t216.state ~= "Return" then
                        v1102("steal", t216.state, "->", "Return", "got current-event egg", t216.target and t216.target.name or "")
                        t216.state = "Return"
                        t216.since = os.clock()
                    else
                        t216.state = "Return"
    ...
    function t216.allowTrain()
        ...
        if t216.running and t216.carrying then
            return false
        end
