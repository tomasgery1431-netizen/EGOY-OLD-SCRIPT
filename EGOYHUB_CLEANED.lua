--[[
    EGOY HUB — CLEANED SOURCE
    Safe formatting pass only.

    No identifiers, strings, control flow, API calls, or logic were intentionally changed.
    Changes: trailing whitespace removed; indentation tabs normalized to four spaces.
]]
