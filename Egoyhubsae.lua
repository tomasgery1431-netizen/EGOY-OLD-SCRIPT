...
v282(v295, "StealSpeed", "Travel speed", "Studs/s — can pullback if this is too high", 50, 500, 300, " studs/s")
v263(v295, "Targeting")
...
(function()
    ...
    local function v1151()
        ...
        if u1128 and typeof(u1127) == "Vector3" then
            return math.clamp(tonumber(t9.StealSpeed) or 300, 50, 500)
        end

        if t9.BypassSpeed == true then
            return math.clamp(tonumber(t9.BypassCap) or 880, 150, 700)
        end
    ...
    local function v1182(p218)
        ...
        if v1682 then
            if v1685 then
                pcall(function()
                    if v1686 then
                        v1686.WalkSpeed = math.clamp(v1151(), 16, 700)
                    end
                end)
        ...
        pcall(function()
            ...
            if v1697 then
                ...
                if u1698 then
                    ...
                    v1686.WalkSpeed = math.clamp(v2771, 16, 700)
                end
            elseif t9.BypassSpeed == true then
                v1686.WalkSpeed = math.clamp(tonumber(t9.BypassCap) or 880, 16, 700)
            else
                v1686.WalkSpeed = n9
            end
    ...
    function t216.applyCarryHover(root)
        ...
        local y = math.clamp(t216.carryHoverY, groundY + 3.5, groundY + 6)
        ...
        if u1127 and not u1116 then
            ...
            pcall(function()
                ...
                if u1128 and typeof(u1127) == "Vector3" then
                    ...
                    v2505.WalkSpeed = math.clamp(math.min(v4575, 700), 16, 700)
                else
                    v2505.WalkSpeed = n9
                end
